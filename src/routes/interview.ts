...
router.post("/start", async (req, res) => {
  ...
  console.log("New session started:", sessions[sessionId]);
...
router.post("/answer", async (req, res) => {
  try {
    ...
    if (disableAI) {
      res.json({
        followUp:
          "Thank you, Sushma. Could you tell me a bit more about your professional background and what brings you here today?",
      });
      return;
    }
